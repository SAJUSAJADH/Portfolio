            ...
            <div id="about" className="bg-white w-full realative py-32">
                <div className="container mx-auto">
                    <div className="grid lg:grid-cols-2">
                        <div className="relative grid justify-center md:justify-end items-center">
                        ...
                        <div className="container mx-auto grid justify-start text-center md:text-start md:w-3/4">
