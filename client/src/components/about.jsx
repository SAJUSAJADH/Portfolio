...
export default function About() {
  const aboutme =
    "👋 Hi there! I'm Sajadh S, a passionate blockchain developer with a strong focus on building dApps using cutting-edge technologies. With a background in Solidity and a knack for full-stack development, I harness the power of modern web development frameworks like Next.js, React, and Vite to build intuitive user interfaces for my blockchain applications. In the backend realm, I'm well-versed in Node.js and Express, enabling me to create scalable and high-performance server-side components that complement the frontend. I am also proficient in Python and AI, integrating intelligent solutions into my projects. Additionally, I have experience in developing React Native apps using Expo, bringing efficient and seamless mobile experiences. TypeScript is my go-to language, providing type safety and scalability across my projects. I am a team player who thrives in collaborating with cross-functional teams to produce outstanding dApps.";
  return (
    <>
